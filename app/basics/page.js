            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {basicDataStructures.map((dataStructure, index) => (
                        <Link key={index} href={`/basics/${dataStructure.slug}`}>
                            <div className="bg-slate-900/70 rounded-xl border border-slate-700/50 hover:border-blue-500/50 shadow-xl hover:shadow-xl transition-all duration-300 overflow-hidden group cursor-pointer">
                                {/* Header */}
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-slate-900/70 rounded-xl border border-slate-700/50 shadow-xl p-6">
                        <h2 className="text-2xl font-bold text-white mb-4">Why Learn Basic Data Structures?</h2>
                    ...
                    <div className="bg-slate-900/70 rounded-xl border border-slate-700/50 shadow-xl p-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center text-sm text-slate-400">
                                <span className="w-6 h-6 bg-blue-500/15 text-blue-400 rounded-full flex items-center justify-center text-xs font-bold mr-3">1</span>
                                Start with Stack (Array)
                            </div>
                            <div className="flex items-center text-sm text-slate-400">
                                <span className="w-6 h-6 bg-blue-500/15 text-blue-400 rounded-full flex items-center justify-center text-xs font-bold mr-3">2</span>
                                Learn Queue (Array)
                            </div>
                            <div className="flex items-center text-sm text-slate-400">
                                <span className="w-6 h-6 bg-blue-500/15 text-blue-400 rounded-full flex items-center justify-center text-xs font-bold mr-3">3</span>
                                Explore Linked implementations
                            </div>
                            <div className="flex items-center text-sm text-slate-400">
                                <span className="w-6 h-6 bg-blue-500/15 text-blue-400 rounded-full flex items-center justify-center text-xs font-bold mr-3">4</span>
                    ...
                    <div className="bg-slate-900/70 rounded-xl border border-slate-700/50 shadow-xl p-6">
                        ...
                        <div className="space-y-4 text-slate-400">
                            <div className="border-l-4 border-blue-400 pl-3">
                                <h3 className="font-semibold text-slate-100 text-sm">LIFO vs FIFO</h3>
                                <p className="text-xs">Last In First Out vs First In First Out principles</p>
                            </div>
                            <div className="border-l-4 border-blue-400 pl-3">
                                <h3 className="font-semibold text-slate-100 text-sm">Memory Management</h3>
                                <p className="text-xs">Array vs Linked List memory allocation patterns</p>
                            </div>
                            <div className="border-l-4 border-blue-400 pl-3">
                                <h3 className="font-semibold text-slate-100 text-sm">Operation Complexity</h3>
                ...
                <div className="mt-12 bg-slate-900/70 rounded-xl border border-slate-700/50 shadow-xl p-8">
                    <h2 className="text-2xl font-bold text-white mb-6 text-center">Array vs Linked List Implementations</h2>
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b-2 border-slate-700/50">
                                    <th className="text-left py-3 px-4 font-semibold text-slate-100">Aspect</th>
