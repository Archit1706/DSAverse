                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className="text-center">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4 flex items-center justify-center gap-3">
                            <Search className="h-10 w-10" />KMP String Matching
                        </h1>
                        <p className="text-xl text-fuchsia-100 mb-6 max-w-3xl mx-auto">
                            Knuth-Morris-Pratt avoids redundant comparisons by pre-computing a failure function.
                            When a mismatch occurs, the pattern shifts by the maximum safe amount — never re-scanning matched characters.
                        </p>
                        <div className="flex flex-wrap justify-center gap-4 text-sm">
                            <div className="bg-white/20 px-3 py-1 rounded-full">Time: O(n + m)</div>
                            <div className="bg-white/20 px-3 py-1 rounded-full">Space: O(m)</div>
                            <div className="bg-white/20 px-3 py-1 rounded-full">Failure Function</div>
            ...
            <div className="max-w-2xl mx-auto px-4 py-24 text-center">
                <div className="bg-slate-900/70 rounded-2xl border border-slate-700/50 p-12">
                    ...
                    <p className="text-slate-400 text-sm leading-relaxed mb-8">
                        An interactive step-by-step visualization for KMP String Matching is currently being built.
                        You will see both phases: failure function construction and the matching scan with skip animations.
                    </p>
