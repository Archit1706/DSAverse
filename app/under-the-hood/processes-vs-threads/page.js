    ...
    return (
        <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center text-center px-4">
            <div className="bg-slate-900/80 border border-slate-700/60 rounded-2xl p-12 max-w-lg">
                ...
                <h1 className="text-2xl font-bold text-white mb-3">Processes vs Threads</h1>
                <p className="text-slate-400 mb-2 leading-relaxed">
                    Virtual address spaces, the process control block, fork() semantics, and why threads share heap but not stack.
                </p>
