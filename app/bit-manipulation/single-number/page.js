                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className="text-center">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4 flex items-center justify-center gap-3">
                            <Zap className="h-10 w-10" />Single Number (XOR)
                        </h1>
                        <p className="text-xl text-teal-100 mb-6 max-w-3xl mx-auto">
                            ...
                            XOR cancels duplicate pairs in a single O(n) pass with no extra space.
                        </p>
                        <div className="flex flex-wrap justify-center gap-4 text-sm">
                            ...
                            <div className="bg-white/20 px-3 py-1 rounded-full">XOR Trick</div>
            ...
            <div className="max-w-2xl mx-auto px-4 py-24 text-center">
                <div className="bg-slate-900/70 rounded-2xl border border-slate-700/50 p-12">
                    ...
                    <p className="text-slate-400 text-sm leading-relaxed mb-8">
                        An interactive step-by-step visualization for Single Number (XOR) is currently being built.
                        You will be able to watch each XOR operation update the binary register and see duplicates cancel out.
                    </p>
