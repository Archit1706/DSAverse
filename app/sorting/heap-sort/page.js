                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-slate-900/70 rounded-xl border border-slate-700/50 shadow-xl p-6 mb-6">
                            ...
                            {/* Array Visualization */}
                            <div className="mb-6">
                                <h3 className="text-lg font-semibold mb-3 text-slate-100">Array Representation</h3>
                            ...
                            {heapTree.length > 0 && (
                                <div className="mb-6">
                                    <h3 className="text-lg font-semibold mb-3 text-slate-100">Binary Heap Tree</h3>
